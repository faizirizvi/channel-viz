(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'dTH6WVh7yEj3Oe4dyHSJ7owxgVSYtEVmkLuPpoAIgwEfxwzf', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1161827086], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Mindtree IOT in Retail', // Replaces Xively logo in the header
		dataDuration	= '', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor		= 'B22222', // CSS HEX value of color to represent data (omit leading #)
